...
@objc class AppDelegate: FlutterAppDelegate {
  private let CHANNEL = "cross_platform_video_thumbnails"
  ...
  override func application(
    ...
    methodChannel.setMethodCallHandler { [weak self] (call: FlutterMethodCall, result: @escaping FlutterResult) in
      ...
      case "generateThumbnail":
        self.handleGenerateThumbnail(call: call, result: result)
        
      case "generateThumbnails":
        self.handleGenerateThumbnails(call: call, result: result)
        
      case "isVideoFormatSupported":
        self.handleIsVideoFormatSupported(call: call, result: result)
